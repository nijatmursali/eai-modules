...
class ReplayBuffer(object):
    ...
    def store_buffer(self, state, action, reward, new_state, done):
    ...
    def sample_buffer(self, batch_size):
        ...
        terminal_st = self.terminal_memory[batch]

        return states, actions, rewards, new_states, terminal_st
...
class Agent(object):
    def __init__(self, alpha, beta, input_dims, tau, env, gamma=0.99, n_actions=2, max_size=1000, layer1_size=400, layer2_size=300, batch_size=64):
        self.gamma = gamma
        self.tau = tau
    ...
    def remember(self, state, action, reward, new_state, done):
        self.memory.store_buffer(state, action, reward, new_state, done)
    ...
    def update_network_params(self, tau = None):
        ...
        for name in actor_state_dict:
            actor_state_dict[name] = tau * actor_state_dict[name].clone() + (1 - tau) * target_actor_dict[
                name].clone()
