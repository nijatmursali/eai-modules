...
class CheckGlasses:
    def __init__(self, path_predictor):
        self.path = path_predictor
    ...
    def generate_np_landmarks(self, original_landmarks, data_type):
    ...
    # ==============================================================================
    def get_centers(self, image, landmarks):
    ...
    # ==============================================================================
    def get_aligned_face(self, image, left, right):
        desired_w = 256
        desired_h = 256
    ...
    # def check_glasses(self, cap):
    #     detector = dlib.get_frontal_face_detector()  # Face detector
    #     predictor = dlib.shape_predictor(self.path)  # Face keypoint detector -> predictor
    ...
    #
    #             # Linear regression
    #             LEFT_EYE_CENTER, RIGHT_EYE_CENTER = self.get_centers(img, landmarks)
    #
    #             # Face alignment
    ...
    #
    #             if self.is_glasses_on(aligned_face):
